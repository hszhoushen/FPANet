...
DATASET_NAME='Places365-14'   # ESC10, ESC50, US8K, SUN_RGBD, NYUdata, Places365-7
...
python -m torch.distributed.launch --master_port 32238 --nproc_per_node=1 train_fpam_esc.py \
