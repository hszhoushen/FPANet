...
python -m torch.distributed.launch --master_port 60011 --nproc_per_node=1 train_fpam_esc.py \
       ...
       --arch $ARCH \
       --status test \
       --model_name DCASE2021-Visual/baseline_resnet50_nomixup_AudioSet_baseline_7f_20_epoch_60_20.pth.tar \
       --fusion True \
       --num_classes 10 \
