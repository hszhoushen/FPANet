...
python -m torch.distributed.launch --master_port 41110 --nproc_per_node=1 train_fpam_esc.py \
       ...
       --fusion True \
       --status test \
       --model_name ADVANCE-Audio/baseline_resnet50_nomixup_AudioSet_baseline_7f_20_epoch_60_20.pth.tar \
       --num_classes 13 \
