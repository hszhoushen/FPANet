...
class DatasetSelection(object):
    def datasetSelection(self, args):
        audio_datasets = ['ESC10', 'ESC50', 'DCASE2019', 'US8K', 'HomeAutomation', 
                          'DCASE2021-Audio', 'DCASE2021-Visual', 'DCASE2021-Audio-Visual', 
                          'ADVANCE-Visual', 'ADVANCE-Audio', 'ADVANCE']
        ...
        if args.dataset_name in audio_datasets:
            if args.dataset_name == 'US8K':
                ...
                # csv_file = '/lintianlin_group_v100/lgzhou/dataset/ESC-50/meta/esc50.csv'
                # data_dir = '/lintianlin_group_v100/lgzhou/dataset/ESC-50/audio/'
                ...
                data_sample = dcase_dataset_construction(args, train_csv_file, val_csv_file, data_dir=data_dir)
                ...
                # train_csv_file = '/lintianlin_group_v100/lgzhou/dataset/DCASE2021/evaluation_setup/fold1_train.csv'
                # val_csv_file = '/lintianlin_group_v100/lgzhou/dataset/DCASE2021/evaluation_setup/fold1_evaluate.csv'
                # data_dir = '/lintianlin_group_v100/lgzhou/dataset/DCASE2021/'
                data_sample = dcase_dataset_construction(args, train_csv_file, val_csv_file, data_dir=data_dir)

            elif args.dataset_name == 'ADVANCE' or args.dataset_name == 'ADVANCE-Visual' or args.dataset_name == 'ADVANCE-Audio':
            ...
            if(args.dataset_name == 'Places365-7'):
                ...
                # data_dir = '/lintianlin_group_v100/lgzhou/dataset/Places365-7'
                ...
                # data_dir = '/lintianlin_group_v100/lgzhou/dataset/Places365-14'
                ...
                data_dir = '/lintianlin_group_v100/lgzhou/dataset/SUNRGBD'
                ...
                # data_dir = '/lintianlin_group_v100/lgzhou/dataset/SUN_RGBD'

            elif (args.dataset_name == 'SUN_RGBD_Full'):
                # data_dir = '/data/dataset/SUN_RGBD'
                data_dir = '/lintianlin_group_v100/lgzhou/dataset/SUN_RGBD_Full/image'
                
            elif (args.dataset_name == 'SUN_RGBD_Depth'):
                data_dir = '/lintianlin_group_v100/lgzhou/dataset/SUN_RGBD_Full/depth'
...
class ImageFolderWithPaths(datasets.ImageFolder):
        ...
        def __getitem__(self, index):
            ...
            # print('ImageFolderWithPaths:', ImageFolderWithPaths)
            ...
            # print('tuple_with_path', tuple_with_path)
