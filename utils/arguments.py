...
class arguments_parse(object):
    def argsParser():
        ...
        parser.add_argument('--visual_pretrain_weights', type=str, default='./weights/advance_visual_pretrain.pth.tar',
                            help='visual net weights')
        parser.add_argument('--audio_pretrain_weights', type=str, default='./weights/advance_audio_pretrain.pth.tar',
                            help='audio net weights')
